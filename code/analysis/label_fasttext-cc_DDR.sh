...
source_path="./"
model_name_or_path="../../data/utilities/sentence-transformers/fasttext-cc-model"
...
python ${source_path}/compute_sbert_avg_lexicon.py --model_name_or_path ${model_name_or_path}\
	...
	--output_file "../../data/tweets/combined_US_politician_twitter_timelines_2010-11-06_to_2022-12-31_honesty_component_scores_fasttext.csv.gzip"\
